...
public class Intenciones  extends AppCompatActivity {
    ...
    public void email(View view) {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "Buen día Ing. Bendezú tengo la siguiente duda...");
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"luislbp16@gmail.com"});
        startActivity(intent);
    }
    ...
    public void whatsapp(View view) {
        ...
        try {
            String url = "https://api.whatsapp.com/send?phone=" + "+51991420679" + "&text="
